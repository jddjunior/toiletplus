...
const AREAS = [
  'Downtown', 'Ballard', 'Northgate', 'Greenwood', 'Fremont', 'Wallingford',
  'Capitol Hill', 'West Seattle', 'Bellevue', 'Redmond', 'Kirkland', 'Renton',
];
  ...
  return (
    <Section tone="muted">
      <SectionHead
        ...
        title="Serving the metro, " accentTitle="plus 30 miles out."
