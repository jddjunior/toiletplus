...
(function () {
  ...
  function Reviews() {
    ...
    const { Section, SectionHead, Icon, useViewport } = window.TPKit;
    ...
    return React.createElement(Section, { id: 'reviews' },
      ...
      React.createElement('div', { style: { display: 'grid', gridTemplateColumns: cols, gap: 18, marginBottom: 36 } },
        REVIEWS.map(([r, q, a, l]) =>
      ...
      React.createElement('div', { style: { display: 'flex', alignItems: 'center', gap: 14, flexWrap: 'wrap', paddingTop: 24, borderTop: '1px solid var(--border-strong)', fontFamily: 'var(--font-mono)', fontSize: 13, letterSpacing: '.04em', textTransform: 'uppercase', color: 'var(--text-muted)' } },
