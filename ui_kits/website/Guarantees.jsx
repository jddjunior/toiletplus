...
(function () {
  ...
  function Guarantees() {
    ...
    return React.createElement('section', { id: 'why', style: { position: 'relative', background: 'var(--surface-navy)', color: '#fff', padding: '100px 0', overflow: 'hidden' } },
      React.createElement('div', { style: { position: 'absolute', inset: 0, ...blueprint('rgba(255,255,255,0.04)', 32), pointerEvents: 'none' } }),
      React.createElement('div', { style: { position: 'relative', maxWidth: 'var(--container-max)', margin: '0 auto', padding: '0 24px', display: 'grid', gridTemplateColumns: '0.85fr 1.15fr', gap: 56 } },
        // left header
        React.createElement('div', null,
          ...
          React.createElement('h2', { style: { fontFamily: 'var(--font-display)', fontWeight: 800, fontSize: 46, lineHeight: 1.02, letterSpacing: '-0.02em', color: '#fff', margin: '0 0 18px' } },
        ...
        // right numbered grid
        React.createElement('div', { style: { display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 0, border: '1px solid var(--border-on-dark)', borderRadius: 'var(--radius-md)', overflow: 'hidden' } },
          ITEMS.map(([n, t, b], i) =>
